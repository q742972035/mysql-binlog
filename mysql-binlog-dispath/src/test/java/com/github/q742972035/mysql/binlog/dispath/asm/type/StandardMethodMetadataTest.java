...
import com.github.q742972035.mysql.binlog.dispath.scan.SimpleMethodMetadata;
import com.github.q742972035.mysql.binlog.dispath.utils.PrintUtils;
...
public class StandardMethodMetadataTest extends AbstractMethodMetadataTests{
    ...
    public void testStandardMethodMetadata() throws NoSuchMethodException {
        ...
        com.github.q742972035.mysql.binlog.dispath.scan.MethodMetadata  methodMetadata = new SimpleMethodMetadata(myUser);
