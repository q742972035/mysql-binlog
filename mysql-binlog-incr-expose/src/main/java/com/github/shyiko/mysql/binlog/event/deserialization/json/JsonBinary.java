...
public class JsonBinary {
     ...
     * a table, but in the case of JSON it is always 3 bytes.
     * <p>
     ...
     * the <i>fsp</i> (i.e., fractional seconds part) defined by a table, but in the case of JSON it is always 3 bytes.
