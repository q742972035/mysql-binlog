...
public enum EventType {
    ...
    ROTATE,
    /**
     * Written every time a statement uses an AUTO_INCREMENT table or the LAST_INSERT_ID() function; precedes other
     ...
     * consists of database and table names and table definitions. The purpose of this event is to enable replication
