...
public abstract class ClassUtils {
    ...
    public static boolean isBase(Class type, Object object) {
        if (object instanceof Integer && type == Integer.TYPE) {
            return true;
        } else if (object instanceof Long && type == Long.TYPE) {
            return true;
        } else if (object instanceof Short && type == Short.TYPE) {
            return true;
        } else if (object instanceof Byte && type == Byte.TYPE) {
            return true;
        } else if (object instanceof Character && type == Character.TYPE) {
            return true;
        } else if (object instanceof Double && type == Double.TYPE) {
            return true;
        } else if (object instanceof Float && type == Float.TYPE) {
            return true;
        } else if (object instanceof Boolean && type == Boolean.TYPE) {
            return true;
        }
