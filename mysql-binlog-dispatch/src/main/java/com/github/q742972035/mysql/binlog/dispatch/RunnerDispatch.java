...
import com.github.q742972035.mysql.binlog.dispatch.scan.ObjectBind;
...
public class RunnerDispatch {
    ...
    public RunnerDispatch(Object methodTarget, MethodMetadata methodMetadata, List<TableElement> tableElements, long currentPosition, long nextPosition) {
