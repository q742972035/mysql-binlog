...
package com.github.q742972035.mysql.binlog.dispatch.asm.utils;


import com.github.q742972035.mysql.binlog.dispatch.asm.annotation.*;
import com.github.q742972035.mysql.binlog.dispatch.asm.core.BridgeMethodResolver;
import com.github.q742972035.mysql.binlog.expose.map.ConcurrentReferenceHashMap;
...
public abstract class AnnotationUtils {
	...
	public static <A extends Annotation> Set<A> getRepeatableAnnotations(AnnotatedElement annotatedElement,
		...
		return MergedAnnotations.from(annotatedElement, MergedAnnotations.SearchStrategy.SUPERCLASS,
	...
	public static <A extends Annotation> Set<A> getDeclaredRepeatableAnnotations(AnnotatedElement annotatedElement,
		...
		RepeatableContainers repeatableContainers = containerAnnotationType != null ?
				RepeatableContainers.of(annotationType, containerAnnotationType) :
				RepeatableContainers.standardRepeatables();
		return MergedAnnotations.from(annotatedElement, MergedAnnotations.SearchStrategy.DIRECT,
	...
	public static <A extends Annotation> A findAnnotation(Method method,  Class<A> annotationType) {
		...
		// Exhaustive retrieval of merged annotations...
		return MergedAnnotations.from(method, MergedAnnotations.SearchStrategy.EXHAUSTIVE,
					RepeatableContainers.none(), AnnotationFilter.PLAIN)
				.get(annotationType).withNonMergedAttributes()
				.synthesize(MergedAnnotation::isPresent).orElse(null);
	}
	...
	public static <A extends Annotation> A findAnnotation(Class<?> clazz,  Class<A> annotationType) {
		...
		// Exhaustive retrieval of merged annotations...
		return MergedAnnotations.from(clazz, MergedAnnotations.SearchStrategy.EXHAUSTIVE,
					RepeatableContainers.none(), AnnotationFilter.PLAIN)
				.get(annotationType).withNonMergedAttributes()
				.synthesize(MergedAnnotation::isPresent).orElse(null);
	}
