...
package com.github.q742972035.mysql.binlog.dispatch.asm.annotation;


import com.github.q742972035.mysql.binlog.dispatch.asm.core.BridgeMethodResolver;
import com.github.q742972035.mysql.binlog.dispatch.asm.core.Ordered;
import com.github.q742972035.mysql.binlog.dispatch.asm.core.ResolvableType;
...
public abstract class AnnotationsScanner {
	...
	private static final Map<AnnotatedElement, Annotation[]> declaredAnnotationCache =
			new ManagedConcurrentWeakHashMap<>(256);
	...
	private static <C, R> R processClassHierarchy(C context, int[] aggregateIndex,
			Class<?> source, AnnotationsProcessor<C, R> processor,
			 BiPredicate<C, Class<?>> classFilter, boolean includeInterfaces) {
	...
	private static <C, R> R processMethodHierarchy(C context, int[] aggregateIndex,
			Class<?> sourceClass, AnnotationsProcessor<C, R> processor,
			 BiPredicate<C, Class<?>> classFilter, Method rootMethod,
	...
	private static <C> Method[] getBaseTypeMethods(
			C context, Class<?> baseType,  BiPredicate<C, Class<?>> classFilter) {
	...
	private static <C, R> Annotation[] getDeclaredAnnotations(C context,
			AnnotatedElement source,  BiPredicate<C, Class<?>> classFilter, boolean copy) {
	...
	private static <C> boolean isFiltered(
			Class<?> sourceClass, C context,  BiPredicate<C, Class<?>> classFilter) {
	...
	static boolean isKnownEmpty(AnnotatedElement source, MergedAnnotations.SearchStrategy searchStrategy) {
		...
		if (searchStrategy == MergedAnnotations.SearchStrategy.DIRECT || isWithoutHierarchy(source)) {
