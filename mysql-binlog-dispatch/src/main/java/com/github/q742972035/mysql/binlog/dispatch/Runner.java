...
import com.github.q742972035.mysql.binlog.dispatch.batch.handler.DdlEventInfoMergeHandler;
import com.github.q742972035.mysql.binlog.dispatch.batch.handler.DmlEventInfoMergeHandler;
import com.github.q742972035.mysql.binlog.dispatch.batch.handler.EventInfoMergeHandler;
import com.github.q742972035.mysql.binlog.dispatch.exception.IllegalMethodException;
import com.github.q742972035.mysql.binlog.dispatch.exception.IllegalUpdateException;
import com.github.q742972035.mysql.binlog.dispatch.exception.MethodAnnotationException;
import com.github.q742972035.mysql.binlog.dispatch.exception.TableHandlerExistException;
import com.github.q742972035.mysql.binlog.dispatch.list.GenerateGroupPrefixName;
import com.github.q742972035.mysql.binlog.dispatch.list.ReadWriteLinkedList;
import com.github.q742972035.mysql.binlog.dispatch.list.ReadWriteLinkedListGroup;
import com.github.q742972035.mysql.binlog.dispatch.list.SubTaskBody;
...
import com.github.q742972035.mysql.binlog.dispatch.scan.ScanResult;
    ...
    static {
        CLOSE_LISTENERS.add((r, e) -> {
            if (e instanceof TableHandlerExistException
                    ...
                    || e instanceof IllegalUpdateException
                    ) {
